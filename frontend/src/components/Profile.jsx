...
function Profile (props) {
  ...
  return (
    <>
      <div className='flex items-center justify-center  px-4 md:px-6 text-black'>
        <div className='bg-opacity-80 rounded-lg shadow-lg py-6 px-6 sm:px-10 w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl'>

          <div className='text-center mb-6'>
            <h3 className='text-2xl md:text-3xl font-bold text-black'>Profile Details</h3>
            <p className='mt-1 text-sm md:text-base text-black'>Details and information about you.</p>
            ...
            <div className='flex-1 space-y-4 w-full flex flex-col justify-center h-full'>
              {[
                ...
                <div key={index} className='grid grid-cols-2 gap-4'>
                  ...
                  <dd
                    className='text-sm md:text-base cursor-pointer hover:text-gray-300 transition text-ellipsis overflow-hidden whitespace-nowrap' onClick={() => copyToClipboard(item.label || 'N/A', item.value || 'N/A')}
                  >
                    {item.value || 'N/A'}
                  </dd>
                </div>
